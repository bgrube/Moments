...
""")
  data = (
    data.Define  ("beamPol",     f"(double){beamPol}")
        ...
        # .Redefine("Phi",         "(double)PhiDeg * TMath::DegToRad()")
        .Redefine("Phi",         "bigPhi(Px_FinalState[0], Py_FinalState[0], Pz_FinalState[0], E_FinalState[0], Px_Beam, Py_Beam, Pz_Beam, E_Beam)")
