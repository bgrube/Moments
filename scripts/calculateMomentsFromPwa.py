...
obtained from photoproduction data.  The calculated moments are
written to a file to be read by the plotting function defined in
`plotMoments.py`.
...
if __name__ == "__main__":
  ...
  print(f"Calculating moment values from partial-wave amplitudes for subsystem '{cfg.subsystem}':")
